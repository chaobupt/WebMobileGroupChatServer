 ...
 */
public class CPABEMHOOHeaderSerParameter extends PairingCipherSerParameter {
    ...
    public CPABEMHOOHeaderSerParameter(PairingParameters pairingParameters, Element C0,
    ...
    public boolean equals(Object anObject) {
        ...
        if (anObject instanceof CPABEMHOOHeaderSerParameter) {
            CPABEMHOOHeaderSerParameter that = (CPABEMHOOHeaderSerParameter)anObject;
            //Compare C0
